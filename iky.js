...
const isNsfw = isGroup ? nsfw.includes(from) : false
     ...
     let weton = ['Pahing', 'Pon','Wage','Kliwon','Legi'][Math.floor(((d * 1) + gmt) / 84600000) % 5]
        ...
        const textImg = (teks) => {
           return ikyy.sendMessage(from, teks, text, {quoted: kyy, thumbnail: fs.readFileSync('./media/wpmobile.png')})
        }
       ...
       const sendKontak = (from, nomor, nama, org = "") => {
	       ...
	       ikyy.sendMessage(from, {displayname: nama, vcard: vcard}, MessageType.contact, {quoted: kyy})
}
...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       // FUNCTION LEVELING
       if (isGroup && !kyy.key.fromMe && !level.isGained(sender)) {
       try {
               ...
               sendButMessage(from, menu, `© Shino`, [
          {
            ...
            type: 1,
              ...
              break
               ...
               prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: kyy, contextInfo:{ forwardingScore:508, mentionedJid:[senderr]}})
                          ikyy.relayWAMessage(prep)
               break
        case 'storymenu':
        case 'moviemenu':
...
`
    ...
    {buttonId: `${prefix}rules`, buttonText: {displayText: 'S&K'}, type: 1},
               ...
               imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpg`), 'imageMessage', { thumbnail:Bfake, contextInfo:{forwardingScore: 989}})).imageMessage
 ...
 `
   ...
   //addfiturbokep
				...
				qute = fs.readFileSync('media/Menu.jpg') 
				   ...
				   ikyy.sendMessage(from, qute, image, { quoted: kyy, caption: '*INGET DOSA KAK*\nLink Download \n\nhttps://www.mediafire.com/file/h2nygxbyb6n9cyo/VID-20210107-WA1468.mp4/file' })
				   break
				   case 'bokep2':
				...
				qute = fs.readFileSync('media/Menu.jpg') 
				if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted: kyy})
   ...
   case 'command':
               list = []
               listmenu = [`groupmenu`,`wibu2`,`porno`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`]
               listmenuu = [`Menu Group`,`Nsfw Anime`,`18+ Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`]
               nombor = 1
               startnum = 0
...
// Islami //
                ...
                case 'jadwalsholat':
                    ...
                    break
      case 'rules':
             ikyy.sendMessage(from, rulesBot(prefix), MessageType.text, {quoted: kyy})
             break
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       ...
       case 'tebaklagu':
              ...
              reply('*+* ```Tebak Lagu```\n\n• *Petunjuk* :'+kisi_kisi+'\n• *Waktu* : 30s')
              ikyy.sendMessage(from, ini_buffer, audio, {quoted: kyy}).then(() => {
       ...
       case 'tebaktebakan':
              ...
              ikyy.sendMessage(from, '*+* ```Tebak Tebakan```\n\n• *soal* :'+pertanyaan+'\n• *kisi²* :'+kisi_kisi, text, { quoted: kyy}).then(() => {
...
_*Tunggu Proses Upload Media......*_`
             reply(result)
             sendFileFromUrl(res[0].link, document, {mimetype: res[0].mime, filename: res[0].nama, quoted: kyy})
             break
...
ikyy.sendMessage(from,{url:'./'+kyyyy},audio,{mimetype:'audio/mpeg'})
  ...
  case 'xnxxsearch':
       ...
       if (!isGroup) return reply(mess.only.group)
             if (!isNsfw) return reply('nsfw belum aktif')
              ...
              ikyy.sendMessage(from, 'Nih kak : '+ xok, text, { quoted: kyy })
              break
                case 'xnxx':
 ...
 Character : ${get_info.characters.join(", ")}\n`
       ...
       case 'doujindesu':
             ...
             ikyy.sendMessage(from, buffer, image, {caption: xixixai, quoted: kyy})
             } catch (e) {
             console.log(e)
             reply(String(e))
}
      ...
      case 'kusonime':
       ...
       case 'nakanoikyy':
       reply (mess.wait)
                    ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=${setting.lolkey}&query=nakanoikyy`)
                    ini_url = ini_url.result
                    buff = await getBuffer(ini_url)
                    buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
...
sendFileFromUrl(res[0].link, audio, {quoted: kyy, mimetype: 'audio/mp4', filename: res[0].output})
}
if (teks.endsWith("-doc")){
...
*[Wait] Tunggu Sebentar..*`
				...
				ikyy.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:kyy, caption: 'Nih Gan'})
					break  
...
\`\`\`Link : ${i.url}\`\`\``
               ...
               b = a.trim()
               sendFileFromUrl(res.all[0].image, image, {quoted: kyy, caption: b})
               } catch (e) {
               console.log(e)
               reply(`${e}`)
}
       ...
       case 'img2url':
              ...
              .then(data => {
               ...
               ikyy.sendMessage(from, ibb, image, { quoted: kyy, caption: caps})
})
              .catch(err => {
               throw err
})
...
//------------------< Level >-------------------
      case 'level': 
              ...
              ikyy.sendMessage(from, buffer, image, { caption: teks, quoted: kyy})
              break
...
break
       case 'attp':
              ...
              ikyy.sendMessage(from, buffer, sticker, { quoted: kyy })
              break
              case 'tg': 
...
break
       ...
       case 'triggered':
                ...
                exec(`webpmux -set exif ./sticker/data.exif ./sticker/triggered.webp -o ./sticker/triggered.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    ikyy.sendMessage(from, fs.readFileSync(`./sticker/triggered.webp`), sticker, {quoted: kyy})
           ...
           teks = args.join(' ')
                ...
                exec(`webpmux -set exif ./sticker/data.exif ./sticker/ttg.webp -o ./sticker/ttg.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    ikyy.sendSticker(from, fs.readFileSync(`./sticker/ttg.webp`), sticker, {quoted: kyy})
                    limitAdd(sender, limit)
       ...
       case 'gifstiker':
            ...
            const media = await ikyy.downloadAndSaveMediaMessage(encmedia)
                ...
                .on('end', function () {
                console.log('Finish')
                ikyy.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: kyy})
                 fs.unlinkSync(media)
                fs.unlinkSync(ran)
                })
                .addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
       ...
       case 'swm':
             ...
             .on('error', (e) => {
              console.log(e)
              ikyy.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: kyy })
              fs.unlinkSync(media)
})
             .on('end', () => {
            _out = getRandom('.webp')
             ...
             .on('exit', () => {
              ikyy.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: kyy })
              fs.unlinkSync(out)
              fs.unlinkSync(_out)
              fs.unlinkSync(media)
})
      ...
      case 'toimg':
              ...
              ikyy.sendMessage(from, buffer, image, {quoted: kyy, caption: 'Nih'})
              fs.unlinkSync(ran)
})
              break
       case 'smeme': 
...
break
       ...
       case 'memegen':                    
        ...
        case 'togif':
               ...
               ikyy.sendMessage(from, mp4, video, {mimetype: 'video/gif', quoted: kyy, caption: mess.success})
        ...
        case 'tovideo':
               ...
               a = await webp2gifFile(mediaaa)
               mp4 = await getBuffer(a.result)
               ikyy.sendMessage(from, mp4, video, {mimetype: 'video/mp4', quoted: kyy, caption: mess.success})
               fs.unlinkSync(mediaaa)
               } else {
               reply(mess.wrongFormat)
}
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:kyy,caption: `*「  SHINO NEWS 」*\n\n${body.slice(4)}`})
}
...
//------------------< G R U P >-------------------
      ...
      case 'demote':
       ...
       case 'profile':
              ...
              ikyy.sendMessage(from, buff, image, {quoted: kyy, caption: profile})
              break
       case 'afk': 
              if (!isGroup) return reply(mess.only.group)
 ...
 ikyy.sendMessage(from, buffer, image, {quoted: kyy}) 
 break
       case 'infogrup':
       case 'infogrouup':
       case 'grupinfo':
...
//------------------< Fun >-------------------
       ...
       case 'toxic':
        ...
        case 'citacita':
              ...
              ikyy.sendMessage(from, cita2, audio,{mimetype: 'audio/mp4', ptt:true, quoted: kyy})
              break
       case 'apakah':
              apakah = body.slice(1)
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              ikyy.sendMessage('62859194143712@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
if (budy.includes("Numa")){
        ...
        ikyy.sendMessage(from, loli, MessageType.audio, {quoted: kyy, mimetype: 'audio/mp4', ptt:true})
...
sendButMessage (from, teks, tek, daftar3, 'extendedTextMessage', {quoted:kyy, contextInfo:{ forwardingScore:508, mentionedJid:[senderr]}})
}
	} 
